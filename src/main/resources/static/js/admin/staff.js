    ...
    switch (role) {
        ...
        case 'NURSE':
            fields = `
                ...
                <input type="text" id="department" name="department" class="mt-1 block w-full px-3 border-0 border-b-2 border-gray-400 focus:border-blue-600 focus:outline-none rounded-md shadow-sm" required />
				<label class="block text-sm font-medium text-gray-700 mt-2">Shift</label>
				<select id="shift" name="shift" class="mt-1 block w-full px-3 border-0 border-b-2 border-gray-400 focus:border-blue-600 focus:outline-none rounded-md shadow-sm">
        ...
        case 'RECEPTIONIST':
            fields = `
                ...
                <input type="text" id="desk" name="desk" class="mt-1 block w-full px-3 border-0 border-b-2 border-gray-400 focus:border-blue-600 focus:outline-none rounded-md shadow-sm" required />
				<label class="block text-sm font-medium text-gray-700 mt-2">Shift</label>
				<select id="shift" name="shift" class="mt-1 block w-full px-3 border-0 border-b-2 border-gray-400 focus:border-blue-600 focus:outline-none rounded-md shadow-sm">
					${generateShiftOptions()}
				</select>
