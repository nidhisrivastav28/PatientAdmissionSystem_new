...
public class DoctorService {
    ...
    public Doctor register(String name, String email, String phone,
            ...
            LocalDate startDate, int experience, String specialisation, String licenseNumber) {

        if (staffAuthRepo.findByEmail(email).isPresent()) {
            throw new IllegalArgumentException("Email already in use: " + email);
        }

        Doctor doctor = new Doctor(name, phone, address, dob, gender, qualification, salary, startDate, experience, specialisation,
                licenseNumber);
