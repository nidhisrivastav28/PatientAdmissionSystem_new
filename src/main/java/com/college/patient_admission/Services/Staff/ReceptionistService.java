...
public class ReceptionistService {
    ...
    public Receptionist register(String name, String email, String phone,
                               ...
                               LocalDate startDate, int experience, String desk, Shift shift) {

        if (staffAuthRepo.findByEmail(email).isPresent()) {
            throw new IllegalArgumentException("Email already in use: " + email);
        }

        Receptionist receptionist = new Receptionist(name, phone, address, dob, gender, qualification, salary, startDate, experience, desk, shift);
