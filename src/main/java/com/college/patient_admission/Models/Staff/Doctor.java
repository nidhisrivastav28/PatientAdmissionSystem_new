...
public class Doctor extends Staff{
	...
	public Doctor(String name, String phone, String address, LocalDate dob, Gender gender, String qualification, double salary, LocalDate startDate, String specialisation, String licenseNumber) {
