...
public abstract class Staff {
	...
	public Staff(String name, String phone, String address, LocalDate dob, Gender gender, String qualification, double salary, LocalDate startDate, int experience) {
		this.name = name;
		this.phone = phone;
